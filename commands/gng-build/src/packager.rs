...
// use gng_core::packet::{PacketWriter, PacketWriterFactory, Path};
// use gng_core::{FacetDefinition, Hash, Name, PacketFileData, Version};
...
//     pub files: Vec<(std::path::PathBuf, gng_core::Hash)>,
// }
...
//     ///
//     /// # Errors
//     /// `gng_core::Error::Runtime` if this given `facet` is not valid
...
//     ///
//     /// # Errors
//     /// `gng_core::Error::Runtime` if this given `path` is not a directory
//     #[tracing::instrument(level = "trace", skip(self))]
//     pub fn add_packet(
//         mut self,
//         data: &PacketFileData,
...
//     ///
//     /// # Errors
//     /// A `gng_core::Error::Runtime` may be returned when the facets are not valid somehow
//     #[tracing::instrument(level = "trace", skip(self))]
...
//                 gng_core::packet::create_packet_writer(
//                     packet_path,
//                     packet_name,
//                     facet_name,
//                     version,
...
//     use gng_core::{packet::PacketWriter, packet::Path, Hash, Name, PacketFileData, Version};
...
//         fn add_path(&mut self, packet_path: &mut Path) -> gng_core::Result<()> {
//             self.result_map
//                 .borrow_mut()
...
//         fn finish(&mut self) -> gng_core::Result<(std::path::PathBuf, Hash)> {
//             Ok((
...
//                 move |path, name, facet, version| -> gng_core::Result<Box<dyn PacketWriter>> {
