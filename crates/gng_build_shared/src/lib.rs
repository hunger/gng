...
pub mod constants {
    ...
    pub mod container {
        ...
        lazy_static::lazy_static! {
            ...
            /// The gng build script
            pub static ref GNG_BUILD_SCRIPT: PathBuf = GNG_DIR.join("build.lua");
    ...
    pub mod environment {
        ...
        /// `GNG_BUILD_SCRIPT` environment variable name
        pub const GNG_BUILD_SCRIPT: &str = "GNG_BUILD_SCRIPT";
        ...
        /// `GNG_AGENT_ERROR_PREFIX` environment variable name
        pub const GNG_AGENT_ERROR_PREFIX: &str = "GNG_AGENT_ERROR_PREFIX";
    }
}
...
mod source_packet;
pub use source_packet::{FacetDefinition, PacketDefinition, SourceDefinition, SourcePacket};
